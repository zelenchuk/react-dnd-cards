...
const initialState = [
    {placeID: 1, title: "Firstly", items: [{itemID: 1}, {itemID: 2}, {itemID: 3}]},
    {placeID: 2, title: "Second", items: [{itemID: 4}]},
    {placeID: 3, title: "Third", items: [{itemID: 5}]},
    {placeID: 4, title: "Fourth", items: [{itemID: 6}]},
    {placeID: 5, title: "Fifth", items: [{itemID: 7}]},
        ...
        <div id={'mainBlock'}>
            {places.map(place =>
                <div className={'placeItem'}>
                    ...
                    {place.items.length !== 0 && place.items.map(item =>
                        <div className={'placeBody'}>
                            {place.items.length !== 0 && (
                                <div className={'itemsElement'}
                                     ...
                                     onDragStart={(e) => onDragStartHandler(e, place, item)}
                                     onDragEnd={(e) => onDragEndHandler(e)}
                                     onDrop={(e) => onDropHandler(e, place, item)}
                                >
                                    {item.itemID}
                                </div>
                            )}
